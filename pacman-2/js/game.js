...
PacmanGame.prototype = {
  ...
  preload: function() {
    ...
    this.load.audio('bul',"assets/bul.mp3");
    this.load.audio('mati',"assets/mati.mp3");
    this.load.audio('telur',"assets/telur.mp3");
    this.load.audio('telurJ',"assets/telurJ.mp3");
  ...
  create: function() {
    musik = this.sound.add('bul');
    musik.play();
    this.map = this.add.tilemap('map');
    this.map.addTilesetImage('pacman-tiles', 'tiles');
    telurkecil = this.sound.add('telur');
    mati = this.sound.add('mati');
